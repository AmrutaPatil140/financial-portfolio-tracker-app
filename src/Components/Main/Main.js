...
import AddStocks from '../AddStocks/AddStocks';
 ...
 class Main extends Component {
     ...
     componentDidMount(){
        axios.get("https://fin-port-track.firebaseio.com/companies.json")
        .then((response)=>{
        ...
        axios.get("https://fin-port-track.firebaseio.com/mystocks.json")
        .then((response)=>{
    ...
    removeStock=(index)=>{
        ...
        let companySymbol=this.state.myStocks[index]["Company_Symbol"];
            ...
            axios.post('https://fin-port-track.firebaseio.com/companies.json', {
                name:companyName,
            ...
            //Deleting stocks from my Stocks
             axios.delete(`https://fin-port-track.firebaseio.com/mystocks/${id}.json`)
             .then((response)=>{
        ...
        addDatatoFirebase=(a,b,c)=>
        {
            ...
            let buyDate=document.getElementById("buyDate").value;
                    if(noofshares>0&&buyPrice.length>0&&buyDate.length>0)
                    {
                            ...
                            axios.post('https://fin-port-track.firebaseio.com/mystocks.json', {
                            ...
                            axios.delete(`https://fin-port-track.firebaseio.com/companies/${id}.json`)
                            .then((response)=>{
